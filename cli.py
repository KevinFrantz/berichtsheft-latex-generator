...
class Main(object):
    ...
    def setUser(self)->User:
        ...
        self.user.setRandomFileUpFrom(self.args.random_fill_up_from)
    def parser(self):
        ...
        parser.add_argument('--random-fill-up-from', default='', help='Time from which logs should be filled up with random commits')
